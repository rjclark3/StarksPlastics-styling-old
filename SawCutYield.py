# -----------------------------------------------------------------
# Assignment Name: Saw Cut Yields
# Name: Rodney Clark
# -----------------------------------------------------------------
import math
import os
...
dblCutSize1 = (dblDimension1 + dblJoint1 + .125)
dblCutSize2 = (dblDimension2 + dblJoint2 + .125)

# Calculate The Yield if cut each direction
dblYield1 = (96 / dblCutSize1) * (48 / dblCutSize2)
dblYield2 = (96 / dblCutSize2) * (48 / dblCutSize1)

# Print results
print("Cut dimensions for this part are " + dblCutSize1 + " x " + dblCutSize2)
print("The cut size of " + dblCutSize1 + " along the 96 yields " + dblYield1 + " pieces.")
print("The cut size of " + dblCutSize2 + " along the 96 yields " + dblYield2 + " pieces.")

#Compare Yield 1 to yield 2 and print result
if ( dblYield1 > dblYield2 ):
